def test_diff_engine_ignores_formatting_changes():
    """
    ...
    r1.bold = True
    d1.save("format_1_pytest.docx")

    d2 = docx.Document()
    p2 = d2.add_paragraph()
    r2 = p2.add_run("Silent Change")
    r2.italic = True
    d2.save("format_2_pytest.docx")

    import subprocess

    diff_output = subprocess.check_output(
        ["uv", "run", "adeu", "diff", "format_1_pytest.docx", "format_2_pytest.docx"]
    ).decode("utf-8")
