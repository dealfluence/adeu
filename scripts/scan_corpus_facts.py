...
Companion to scripts/fetch_corpus.py (see specs/content-controls/spec-corpus.md).
...
A5 acceptance floors are ~95% of these facts — after --write, re-check that the floors
in specs/content-controls/acceptance/A5-corpus-validation.md still hold.
Stdlib only.
"""
